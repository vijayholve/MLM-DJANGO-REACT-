...
class MLMUserSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        spon`sor_code = validated_data.pop('sponsor_code', None)  # Remove sponsor_code from validated_data
        ...
        if sponsor_code:
            # Here, sponsor_code is already an MLMUser instance (not a string), so we can use it directly
