  ...
  useEffect(() => {
    const loadTreeData = async () => {
        ...
        if (data && Array.isArray(data)) {
          setTreeData([data]); // Wrap in array format expected by react-d3-tree
        } else {
            ...
            return (
              <g>
                ...
                <text x="0" y="-35" textAnchor="middle" fill="black">
                  {nodeDatum.name || "N/A"}  {/* Handle case where name is undefined */}
                </text>
                <text x="0" y="35" textAnchor="middle" fill="gray">
                  {nodeDatum.rank || "Unknown"} - ${nodeDatum.total_sales || "0.00"}
                </text>
              </g>
            );
          }}
