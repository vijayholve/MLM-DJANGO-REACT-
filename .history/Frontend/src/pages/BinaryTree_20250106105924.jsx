  ...
  return (
    <div style={containerStyles}>
      <Tree
        ...
        translate={{ x: 600, y: 100 }}  // Static center position
        nodeSvgShape={{
          shape: "circle",
          shapeProps: { r: 25, fill: "#007BFF" },
        }}
        separation={{ siblings: 1.5, nonSiblings: 2 }}
        renderCustomNodeElement={({ nodeDatum }) => (
          <g>
            <circle r={30} fill="#007BFF" />
            <text x="0" y="-35" textAnchor="middle" fill="white" fontSize="14px">
              {nodeDatum.name}
            </text>
            <text x="0" y="35" textAnchor="middle" fill="gray" fontSize="12px">
              {nodeDatum.rank || "Level"}
            </text>
          </g>
        )}
      />
